    ...
    <div style={{ paddingTop: 100 }}>
      ...
      <section style={{ padding: "80px 24px 60px" }}>
        <div style={{ maxWidth: 1200, margin: "0 auto" }}>
          ...
          >
            {["Modern Technologies", "Professional Documentation", "Technical Mentoring", "Presentation Support"].map(
              (f) => (
                <span
                  key={f}
                  style={{
          ...
          >
            {FYP_PLANS.map((plan) => (
              <div
                ...
                style={{
                  position: "relative",
                  outline: plan.popular ? `1.5px solid ${plan.color}55` : "none",
                }}
              >
                {plan.popular && (
                  <div
                ...
                <div style={{ padding: "32px 28px 0" }}>
                  ...
                  <h3
                    className="font-display"
                    style={{ fontSize: 22, fontWeight: 800, marginBottom: 6, letterSpacing: "-0.02em" }}
                  >
                    {plan.name}
                  </h3>
                ...
                <div style={{ padding: "24px 28px 28px" }}>
                  <a
                    href={`${WA_BASE}&plan=${encodeURIComponent(plan.name)}`}
                    target="_blank"
                    rel="noreferrer"
                    className="btn-ghost"
